...
public class Detonator : MonoBehaviour {
	...
	*/
	...
	void Awake() 
	{
        ...
        _components = this.GetComponents(typeof(DetonatorComponent));
		foreach (DetonatorComponent dc in _components)
		{
	...
	void UpdateComponents()
	{
		...
		{
			foreach (DetonatorComponent component in _components)
			{
				component.Init();
